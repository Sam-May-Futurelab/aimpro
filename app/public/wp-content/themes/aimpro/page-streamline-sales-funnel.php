    ...
    <div class="container">
        ...
        <section class="page-header">
            <div class="page-header-content">
                <h1>Streamline Your Sales Funnel</h1>
                <p class="page-subtitle">Optimize every stage of your sales process to convert more prospects into paying customers</p>
            </div>
        </section>
            ...
            <div class="section-content">
                <div class="overview-content">
                    <div class="overview-text">
                        <h2>Turn More Prospects Into Customers</h2>
                        <p>A well-optimized sales funnel is the difference between business growth and stagnation. Our systematic approach identifies bottlenecks, eliminates friction, and creates a smooth journey that guides prospects from awareness to purchase. We build funnels that work around the clock to grow your business.</p>
                        
                        <div class="solution-challenges">
                            <h3>Sales Funnel Problems We Solve:</h3>
                            <ul>
                                <li>High drop-off rates between stages</li>
                                <li>Poor lead qualification processes</li>
                                <li>Inconsistent follow-up sequences</li>
                                <li>Lack of funnel visibility and tracking</li>
                                <li>Misaligned marketing and sales efforts</li>
                                <li>Manual processes slowing conversions</li>
                            </ul>
                        </div>
                    </div>
                    <div class="overview-image">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/solutions/sales-funnel-overview.jpg" alt="Sales Funnel Optimization Strategy" />
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="funnel-services">
            <div class="section-content">
                <h2>Our Sales Funnel Optimization Services</h2>
            ...
            <div class="section-content">
                <div class="case-study-content">
                    <div class="case-study-text">
                        ...
                        <h2>TechFlow Solutions: 400% Sales Velocity Increase</h2>
                        <p>TechFlow Solutions, a B2B software company, had a complex 6-month sales cycle with low conversion rates and high customer acquisition costs.</p>
                        
                        <div class="case-study-challenge">
                            <h3>The Challenge</h3>
                            <ul>
                                <li>6-month average sales cycle</li>
                                <li>12% lead-to-customer conversion rate</li>
                                <li>$8,500 customer acquisition cost</li>
                                <li>Poor visibility into funnel performance</li>
                            </ul>
                        </div>
                        ...
                        <div class="case-study-solution">
                            <h3>Our Solution</h3>
                            <ul>
                                <li>Complete funnel redesign and optimization</li>
                                <li>Automated lead qualification system</li>
                                <li>Multi-touch nurture sequences</li>
                    ...
                    <div class="case-study-results">
                        ...
                        <div class="results-grid">
                            <div class="result-item">
                                ...
                                <div class="result-label">Sales Velocity Increase</div>
                            </div>
                            <div class="result-item">
                            ...
                            <div class="result-item">
                                <div class="result-number">$3,200</div>
                                <div class="result-label">Reduced CAC</div>
                            </div>
                        </div>
        ...
        <section class="funnel-process">
            <div class="section-content">
                <h2>Our Sales Funnel Optimization Process</h2>
        ...
        <section class="funnel-types">
            <div class="section-content">
                <h2>Sales Funnel Optimization by Business Type</h2>
        ...
        <section class="funnel-tools">
            <div class="section-content">
                <h2>Sales Funnel Technology Stack</h2>
        ...
        <section class="funnel-testimonial">
            <div class="section-content">
                <div class="testimonial-content">
                    <blockquote>
                        "Aimpro Digital transformed our entire sales process. We went from a chaotic, manual system to a streamlined funnel that runs automatically. Our sales velocity increased by 400% and our team is now much more efficient."
                    </blockquote>
                    <div class="testimonial-author">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/testimonials/funnel-michael.jpg" alt="Michael Rodriguez" />
        ...
        <section class="funnel-cta">
            <div class="section-content">
                ...
                <div class="cta-buttons">
                    <a href="<?php echo home_url('/contact'); ?>" class="btn btn-primary">Get Free Funnel Analysis</a>
                    <a href="<?php echo home_url('/case-studies'); ?>" class="btn btn-secondary">View Funnel Success Stories</a>
                </div>
                <div class="cta-benefits">
                    <span class="benefit">✓ Complete funnel audit included</span>
                    <span class="benefit">✓ Custom optimization strategy</span>
                    <span class="benefit">✓ Automated follow-up setup</span>
                </div>
            </div>
        </section>
