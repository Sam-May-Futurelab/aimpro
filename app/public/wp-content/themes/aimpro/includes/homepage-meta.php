...
function aimpro_homepage_meta_callback($post) {
    ...
    <style>
        ...
        .aimpro-meta-row label {
            display: block;
            font-weight: bold;
            margin-bottom: 5px;
        }
        .aimpro-meta-row input[type="text"],
        .aimpro-meta-row input[type="url"],
        .aimpro-meta-row textarea {
            width: 100%;
            padding: 8px;
            border: 1px solid #ddd;
            border-radius: 3px;
    ...
    <div class="aimpro-homepage-meta">
        ...
        <!-- Hero Section -->
        <div class="aimpro-meta-section">
            <h3>Hero Section</h3>
            
            <div class="aimpro-meta-row">
                <label for="hero_badge_text">Hero Badge Text:</label>
                <input type="text" id="hero_badge_text" name="hero_badge_text" value="<?php echo esc_attr($hero_badge_text ?: 'Award-Winning Digital Agency'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="hero_title">Hero Title (HTML allowed):</label>
                <textarea id="hero_title" name="hero_title"><?php echo esc_textarea($hero_title ?: '<h1 class="hero-title">Scale Your Business With <span class="curly-underline">PRECISION</span> Digital <span class="highlight-word" style="colour: #f15a25 !important; -webkit-text-fill-colour: #f15a25 !important;">Marketing</span></h1>'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="hero_strapline_1">Hero Strapline 1:</label>
                <input type="text" id="hero_strapline_1" name="hero_strapline_1" value="<?php echo esc_attr($hero_strapline_1 ?: 'No Fluff. Just Results.'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="hero_strapline_2">Hero Strapline 2:</label>
                <input type="text" id="hero_strapline_2" name="hero_strapline_2" value="<?php echo esc_attr($hero_strapline_2 ?: 'Data-Driven Strategy. Measurable Results.'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="hero_strapline_3">Hero Strapline 3:</label>
                <input type="text" id="hero_strapline_3" name="hero_strapline_3" value="<?php echo esc_attr($hero_strapline_3 ?: 'Grow Your Business With Precision Marketing.'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="hero_strapline_4">Hero Strapline 4:</label>
                <input type="text" id="hero_strapline_4" name="hero_strapline_4" value="<?php echo esc_attr($hero_strapline_4 ?: 'Your High-ROI Digital Marketing Partner'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="hero_subtitle">Hero Subtitle (HTML allowed):</label>
                <textarea id="hero_subtitle" name="hero_subtitle"><?php echo esc_textarea($hero_subtitle ?: 'Expert Lead Generation, SEO, PPC & Automation. Data-driven strategies that deliver <strong class="highlight-underline">MEASURABLE RESULTS</strong> and accelerate your <strong class="highlight-word">growth</strong>.'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="hero_primary_cta_text">Hero CTA Text:</label>
                <input type="text" id="hero_primary_cta_text" name="hero_primary_cta_text" value="<?php echo esc_attr($hero_primary_cta_text ?: 'CLAIM YOUR FREE GROWTH STRATEGY'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="hero_primary_cta_url">Hero CTA URL:</label>
                <input type="url" id="hero_primary_cta_url" name="hero_primary_cta_url" value="<?php echo esc_attr($hero_primary_cta_url ?: '#contact'); ?>" />
            </div>
        </div>
        ...
        <div class="aimpro-meta-section">
            ...
            <div class="aimpro-meta-row">
                <label for="value_statement_title">Value Statement Title (HTML allowed):</label>
                <textarea id="value_statement_title" name="value_statement_title"><?php echo esc_textarea($value_statement_title ?: 'A Results-Driven Digital Agency Obsessed With Your <span class="highlight curly-underline">SUCCESS</span>'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="value_statement_description">Value Statement Description:</label>
                <textarea id="value_statement_description" name="value_statement_description"><?php echo esc_textarea($value_statement_description ?: 'We partner with ambitious businesses to transform their digital presence through intelligent strategies and performance-focused marketing. Our proven methodologies deliver quantifiable results that drive exponential growth and maximise your competitive advantage.'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="value_statement_cta_text">Value Statement CTA Text:</label>
                <input type="text" id="value_statement_cta_text" name="value_statement_cta_text" value="<?php echo esc_attr($value_statement_cta_text ?: 'CLAIM YOUR FREE GROWTH AUDIT'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="value_statement_cta_url">Value Statement CTA URL:</label>
                <input type="url" id="value_statement_cta_url" name="value_statement_cta_url" value="<?php echo esc_attr($value_statement_cta_url ?: '#contact'); ?>" />
            </div>
        </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div>
                    <div class="aimpro-meta-row">
                        ...
                        <input type="text" id="stat_1_number" name="stat_1_number" value="<?php echo esc_attr($stat_1_number ?: '25'); ?>" />
                    </div>
                    
                    <div class="aimpro-meta-row">
                        <label for="stat_1_label">Stat 1 Label:</label>
                        <input type="text" id="stat_1_label" name="stat_1_label" value="<?php echo esc_attr($stat_1_label ?: 'Years of Experience'); ?>" />
                    </div>
                </div>
                ...
                <div>
                    <div class="aimpro-meta-row">
                        ...
                        <input type="text" id="stat_2_number" name="stat_2_number" value="<?php echo esc_attr($stat_2_number ?: '98'); ?>" />
                    </div>
                    
                    <div class="aimpro-meta-row">
                        <label for="stat_2_label">Stat 2 Label:</label>
                        <input type="text" id="stat_2_label" name="stat_2_label" value="<?php echo esc_attr($stat_2_label ?: 'Increase in Client Leads'); ?>" />
                    </div>
                </div>
                ...
                <div>
                    <div class="aimpro-meta-row">
                        ...
                        <input type="text" id="stat_3_number" name="stat_3_number" value="<?php echo esc_attr($stat_3_number ?: '25'); ?>" />
                    </div>
                    
                    <div class="aimpro-meta-row">
                        <label for="stat_3_label">Stat 3 Label:</label>
                        <input type="text" id="stat_3_label" name="stat_3_label" value="<?php echo esc_attr($stat_3_label ?: 'Industries Transformed'); ?>" />
                    </div>
                </div>
                ...
                <div>
                    <div class="aimpro-meta-row">
                        ...
                        <input type="text" id="stat_4_number" name="stat_4_number" value="<?php echo esc_attr($stat_4_number ?: '199'); ?>" />
                    </div>
                    
                    <div class="aimpro-meta-row">
                        <label for="stat_4_label">Stat 4 Label:</label>
                        <input type="text" id="stat_4_label" name="stat_4_label" value="<?php echo esc_attr($stat_4_label ?: 'Increase in Conversion Rates'); ?>" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="aimpro-meta-section">
            ...
            <div class="aimpro-meta-row">
                <label for="services_title">Services Title (HTML allowed):</label>
                <textarea id="services_title" name="services_title"><?php echo esc_textarea($services_title ?: 'Premium Digital Marketing Solutions That <span class="highlight curly-underline">DELIVER</span>'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="services_subtitle">Services Subtitle:</label>
                <textarea id="services_subtitle" name="services_subtitle"><?php echo esc_textarea($services_subtitle ?: 'Zero fluff. Pure performance. Our integrated marketing ecosystem works seamlessly to transform prospects into profits.'); ?></textarea>
            </div>
        </div>
        ...
        <div class="aimpro-meta-section">
            ...
            <div class="aimpro-meta-row">
                <label for="lead_magnet_title">Lead Magnet Title (HTML allowed):</label>
                <textarea id="lead_magnet_title" name="lead_magnet_title"><?php echo esc_textarea($lead_magnet_title ?: 'Get Our Free Digital Marketing <span class="highlight curly-underline">GUIDE</span>'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="lead_magnet_subtitle">Lead Magnet Subtitle:</label>
                <textarea id="lead_magnet_subtitle" name="lead_magnet_subtitle"><?php echo esc_textarea($lead_magnet_subtitle ?: 'Download our comprehensive digital marketing guide packed with proven strategies to grow your business.'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="lead_magnet_ebook_title">Ebook Title:</label>
                <input type="text" id="lead_magnet_ebook_title" name="lead_magnet_ebook_title" value="<?php echo esc_attr($lead_magnet_ebook_title ?: 'The Ultimate Digital Marketing Playbook'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="lead_magnet_ebook_description">Ebook Description:</label>
                <textarea id="lead_magnet_ebook_description" name="lead_magnet_ebook_description"><?php echo esc_textarea($lead_magnet_ebook_description ?: 'Discover the exact strategies we use to help our clients increase leads by 200%+ and dominate their local markets.'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="lead_magnet_form_title">Form Title:</label>
                <input type="text" id="lead_magnet_form_title" name="lead_magnet_form_title" value="<?php echo esc_attr($lead_magnet_form_title ?: 'Get Your Free Digital Marketing Guide'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="lead_magnet_form_subtitle">Form Subtitle:</label>
                <textarea id="lead_magnet_form_subtitle" name="lead_magnet_form_subtitle"><?php echo esc_textarea($lead_magnet_form_subtitle ?: 'Fill out the form below and we\'ll send you our comprehensive guide plus schedule a free consultation.'); ?></textarea>
            </div>
        </div>
        ...
        <div class="aimpro-meta-section">
            ...
            <div class="aimpro-meta-row">
                <label for="office_title">Office Title (HTML allowed):</label>
                <textarea id="office_title" name="office_title"><?php echo esc_textarea($office_title ?: 'Come See Us... We\'re a <span class="highlight curly-underline">REAL</span> Company with Real Humans'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="office_description">Office Description:</label>
                <textarea id="office_description" name="office_description"><?php echo esc_textarea($office_description ?: 'Let\'s discuss your project over a coffee. Book a time to visit our Birmingham office and meet the team behind your marketing success.'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="coffee_meeting_url">Coffee Meeting URL:</label>
                <input type="url" id="coffee_meeting_url" name="coffee_meeting_url" value="<?php echo esc_attr($coffee_meeting_url ?: '#contact'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="office_address_title">Office Address Title:</label>
                <input type="text" id="office_address_title" name="office_address_title" value="<?php echo esc_attr($office_address_title ?: 'Our Birmingham Office'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="office_address">Office Address (HTML allowed):</label>
                <textarea id="office_address" name="office_address"><?php echo esc_textarea($office_address ?: '<p><strong>Located in: 55 Colmore Row</strong><br>Address: 55 Colmore Row, Birmingham B3 2AA<br>Right in the heart of Birmingham\'s business district</p>'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="about_page_url">About Page URL:</label>
                <input type="url" id="about_page_url" name="about_page_url" value="<?php echo esc_attr($about_page_url ?: '/about'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="team_section_url">Team Section URL:</label>
                <input type="url" id="team_section_url" name="team_section_url" value="<?php echo esc_attr($team_section_url ?: '#team'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="company_page_url">Company Page URL:</label>
                <input type="url" id="company_page_url" name="company_page_url" value="<?php echo esc_attr($company_page_url ?: '#contact'); ?>" />
            </div>
        </div>
        ...
        <div class="aimpro-meta-section">
            ...
            <div class="aimpro-meta-row">
                <label for="team_section_title">Team Section Title (HTML allowed):</label>
                <textarea id="team_section_title" name="team_section_title"><?php echo esc_textarea($team_section_title ?: 'Meet The Experts Who Make <span class="highlight curly-underline">MAGIC</span> Happen'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="team_section_subtitle">Team Section Subtitle:</label>
                <textarea id="team_section_subtitle" name="team_section_subtitle"><?php echo esc_textarea($team_section_subtitle ?: 'No faceless agencies here. Our marketing specialists are passionate about client success and personally invested in delivering exceptional results for every business we partner with.'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="team_cta_text">Team CTA Text:</label>
                <input type="text" id="team_cta_text" name="team_cta_text" value="<?php echo esc_attr($team_cta_text ?: 'TALK TO OUR EXPERTS'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="team_cta_url">Team CTA URL:</label>
                <input type="url" id="team_cta_url" name="team_cta_url" value="<?php echo esc_attr($team_cta_url ?: '/contact'); ?>" />
            </div>
        </div>
        ...
        <div class="aimpro-meta-section">
            ...
            <div class="aimpro-meta-row">
                ...
                <input type="text" id="testimonials_badge" name="testimonials_badge" value="<?php echo esc_attr($testimonials_badge ?: 'Client Success Stories'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="testimonials_title">Testimonials Title:</label>
                <input type="text" id="testimonials_title" name="testimonials_title" value="<?php echo esc_attr($testimonials_title ?: 'Real Results from Real Businesses'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="testimonials_subtitle">Testimonials Subtitle:</label>
                <textarea id="testimonials_subtitle" name="testimonials_subtitle"><?php echo esc_textarea($testimonials_subtitle ?: 'Don\'t just take our word for it. Here\'s what our clients have to say about the transformative results we\'ve delivered for their businesses.'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="testimonials_cta_text">Testimonials CTA Text:</label>
                <input type="text" id="testimonials_cta_text" name="testimonials_cta_text" value="<?php echo esc_attr($testimonials_cta_text ?: 'START YOUR SUCCESS STORY'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="testimonials_cta_url">Testimonials CTA URL:</label>
                <input type="url" id="testimonials_cta_url" name="testimonials_cta_url" value="<?php echo esc_attr($testimonials_cta_url ?: '/contact'); ?>" />
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                <div>
                    <div class="aimpro-meta-row">
                        ...
                        <input type="text" id="testimonials_stat_1_number" name="testimonials_stat_1_number" value="<?php echo esc_attr($testimonials_stat_1_number ?: '500+'); ?>" />
                    </div>
                    
                    <div class="aimpro-meta-row">
                        <label for="testimonials_stat_1_label">Testimonials Stat 1 Label:</label>
                        <input type="text" id="testimonials_stat_1_label" name="testimonials_stat_1_label" value="<?php echo esc_attr($testimonials_stat_1_label ?: 'Happy Clients'); ?>" />
                    </div>
                </div>
                ...
                <div>
                    <div class="aimpro-meta-row">
                        ...
                        <input type="text" id="testimonials_stat_2_number" name="testimonials_stat_2_number" value="<?php echo esc_attr($testimonials_stat_2_number ?: '98%'); ?>" />
                    </div>
                    
                    <div class="aimpro-meta-row">
                        <label for="testimonials_stat_2_label">Testimonials Stat 2 Label:</label>
                        <input type="text" id="testimonials_stat_2_label" name="testimonials_stat_2_label" value="<?php echo esc_attr($testimonials_stat_2_label ?: 'Client Satisfaction'); ?>" />
                    </div>
                </div>
                ...
                <div>
                    <div class="aimpro-meta-row">
                        ...
                        <input type="text" id="testimonials_stat_3_number" name="testimonials_stat_3_number" value="<?php echo esc_attr($testimonials_stat_3_number ?: '150%'); ?>" />
                    </div>
                    
                    <div class="aimpro-meta-row">
                        <label for="testimonials_stat_3_label">Testimonials Stat 3 Label:</label>
                        <input type="text" id="testimonials_stat_3_label" name="testimonials_stat_3_label" value="<?php echo esc_attr($testimonials_stat_3_label ?: 'Average ROI Increase'); ?>" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="aimpro-meta-section">
            ...
            <div class="aimpro-meta-row">
                <label for="blog_title">Blog Title (HTML allowed):</label>
                <textarea id="blog_title" name="blog_title"><?php echo esc_textarea($blog_title ?: 'Scale Up Your <span class="highlight curly-underline">MARKETING</span>'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="blog_subtitle">Blog Subtitle:</label>
                <textarea id="blog_subtitle" name="blog_subtitle"><?php echo esc_textarea($blog_subtitle ?: 'Zero secrets. Maximum value. We share proven strategies and insider insights to help ambitious marketers like you accelerate growth, drive traffic, and maximise revenue.'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="blog_cta_text">Blog CTA Text:</label>
                <input type="text" id="blog_cta_text" name="blog_cta_text" value="<?php echo esc_attr($blog_cta_text ?: 'MORE BLOGS'); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="blog_cta_url">Blog CTA URL:</label>
                <input type="url" id="blog_cta_url" name="blog_cta_url" value="<?php echo esc_attr($blog_cta_url ?: '/blog'); ?>" />
            </div>
        </div>
        ...
        <div class="aimpro-meta-section">
            ...
            <div class="aimpro-meta-row">
                ...
                <input type="url" id="homepage_blog_1_image" name="homepage_blog_1_image" value="<?php echo esc_attr($homepage_blog_1_image); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_1_date">Blog 1 Date:</label>
                <input type="text" id="homepage_blog_1_date" name="homepage_blog_1_date" value="<?php echo esc_attr($homepage_blog_1_date); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_1_category">Blog 1 Category:</label>
                <input type="text" id="homepage_blog_1_category" name="homepage_blog_1_category" value="<?php echo esc_attr($homepage_blog_1_category); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_1_title">Blog 1 Title:</label>
                <input type="text" id="homepage_blog_1_title" name="homepage_blog_1_title" value="<?php echo esc_attr($homepage_blog_1_title); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_1_excerpt">Blog 1 Excerpt:</label>
                <textarea id="homepage_blog_1_excerpt" name="homepage_blog_1_excerpt"><?php echo esc_textarea($homepage_blog_1_excerpt); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_1_url">Blog 1 URL:</label>
                <input type="url" id="homepage_blog_1_url" name="homepage_blog_1_url" value="<?php echo esc_attr($homepage_blog_1_url); ?>" />
            </div>
            ...
            <div class="aimpro-meta-row">
                ...
                <input type="url" id="homepage_blog_2_image" name="homepage_blog_2_image" value="<?php echo esc_attr($homepage_blog_2_image); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_2_date">Blog 2 Date:</label>
                <input type="text" id="homepage_blog_2_date" name="homepage_blog_2_date" value="<?php echo esc_attr($homepage_blog_2_date); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_2_category">Blog 2 Category:</label>
                <input type="text" id="homepage_blog_2_category" name="homepage_blog_2_category" value="<?php echo esc_attr($homepage_blog_2_category); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_2_title">Blog 2 Title:</label>
                <input type="text" id="homepage_blog_2_title" name="homepage_blog_2_title" value="<?php echo esc_attr($homepage_blog_2_title); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_2_excerpt">Blog 2 Excerpt:</label>
                <textarea id="homepage_blog_2_excerpt" name="homepage_blog_2_excerpt"><?php echo esc_textarea($homepage_blog_2_excerpt); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_2_url">Blog 2 URL:</label>
                <input type="url" id="homepage_blog_2_url" name="homepage_blog_2_url" value="<?php echo esc_attr($homepage_blog_2_url); ?>" />
            </div>
            ...
            <div class="aimpro-meta-row">
                ...
                <input type="url" id="homepage_blog_3_image" name="homepage_blog_3_image" value="<?php echo esc_attr($homepage_blog_3_image); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_3_date">Blog 3 Date:</label>
                <input type="text" id="homepage_blog_3_date" name="homepage_blog_3_date" value="<?php echo esc_attr($homepage_blog_3_date); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_3_category">Blog 3 Category:</label>
                <input type="text" id="homepage_blog_3_category" name="homepage_blog_3_category" value="<?php echo esc_attr($homepage_blog_3_category); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_3_title">Blog 3 Title:</label>
                <input type="text" id="homepage_blog_3_title" name="homepage_blog_3_title" value="<?php echo esc_attr($homepage_blog_3_title); ?>" />
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_3_excerpt">Blog 3 Excerpt:</label>
                <textarea id="homepage_blog_3_excerpt" name="homepage_blog_3_excerpt"><?php echo esc_textarea($homepage_blog_3_excerpt); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="homepage_blog_3_url">Blog 3 URL:</label>
                <input type="url" id="homepage_blog_3_url" name="homepage_blog_3_url" value="<?php echo esc_attr($homepage_blog_3_url); ?>" />
            </div>
        </div>
        ...
        <div class="aimpro-meta-section">
            ...
            <div class="aimpro-meta-row">
                <label for="final_cta_title">Final CTA Title (HTML allowed):</label>
                <textarea id="final_cta_title" name="final_cta_title"><?php echo esc_textarea($final_cta_title ?: 'You Bring the Ambition, We Drive the <span class="highlight curly-underline">RESULTS</span>'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="final_cta_description">Final CTA Description:</label>
                <textarea id="final_cta_description" name="final_cta_description"><?php echo esc_textarea($final_cta_description ?: 'Request a marketing review today. We\'ll send you a detailed analysis of your website and marketing, breaking down your next steps to success.'); ?></textarea>
            </div>
        </div>
        ...
        <div class="aimpro-meta-section">
            ...
            <div class="aimpro-meta-row">
                <label for="newsletter_title">Newsletter Title (HTML allowed):</label>
                <textarea id="newsletter_title" name="newsletter_title"><?php echo esc_textarea($newsletter_title ?: 'Stay Updated with the <span class="highlight curly-underline">Latest</span> Insights'); ?></textarea>
            </div>
            
            <div class="aimpro-meta-row">
                <label for="newsletter_subtitle">Newsletter Subtitle:</label>
                <textarea id="newsletter_subtitle" name="newsletter_subtitle"><?php echo esc_textarea($newsletter_subtitle ?: 'Get the latest resources, industry updates, and expert tips delivered directly to your inbox every week.'); ?></textarea>
            </div>
        </div>
