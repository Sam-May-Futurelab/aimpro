            ...
            <div class="section-content">
                <div class="content-grid">
                    <div class="content-text">
                        ...
                        ?>
                        <img src="<?php echo esc_url($company_image ?: $default_image); ?>" alt="55 Colmore Row Birmingham Office - Aimpro Digital" />
                    </div>
                </div>
            </div>
            ...
            <div class="section-content">
                ...
                <div class="stats-grid">
                    ...
                    for ($i = 1; $i <= 6; $i++) {
                        ...
                        if (!$stat_data) {
                            // If we don't have a default from the old template, continue
                            if ($i > 6) continue;
                            
                            // Default values from original template (copied from meta.php)
                            $defaults = array(
                                '500+|Clients Served|Businesses we\'ve helped grow',
                                '$50M+|Revenue Generated|For our clients collectively',
